...
class IForest(BaseDetector):
    ...
    def decision_function(self, X):
        ...
        """
        # Check if model is fitted by directly checking attributes
        if not hasattr(self, 'decision_scores_') or not hasattr(self, 'threshold_') or not hasattr(self, 'labels_'):
